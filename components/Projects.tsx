  ...
  return (
    <section ref={sectionRef} id="projects" className="py-28 max-w-6xl mx-auto px-8 md:px-16">
      ...
      <div className="proj-grid grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects.map((proj, i) => (
          ...
          >
            ...
            {/* Arrow */}
            <div className="absolute bottom-6 right-6 font-mono text-sm opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 text-cyan-400">
              →
            </div>
          </a>
        ))}
      ...
      <div className="mt-10 flex items-center justify-center">
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="group-hover:text-white transition-colors">
