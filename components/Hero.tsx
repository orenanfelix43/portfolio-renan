  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8 md:px-16 pt-32 pb-24">
        ...
        >
          <span className="accent-dot inline-block w-2 h-2 rounded-full bg-cyan-400" />
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-gray-600 font-mono text-[10px] tracking-widest uppercase">
        <span>scroll</span>
